...
本アルゴリズムのように，対象物に向けてハンドの根元側から狭めて位置決め精度を高めていき，これを維持した状態で手先リンクを対象物まで狭めきろうとすると関節角度上限により\figref{fig::afterfc}の左ハンドのように，対象物まで狭めきれない場合がある．現在は上限角度が$90^{\circ}$となっているが，実機を改良して$90^{\circ}$以上回転を可能にすることで，更なる精度向上が望める．
\begin{figure}[h]
\centering
